...
*** Variables ***
${REMOTE_URL_LOCAL}       http://localhost:4723
${REMOTE_URL_BSTACK}      https://hub-cloud.browserstack.com/
...
Abrir Aplicativo BrowserStack
    ...
    Log    Usando BrowserStack com usuário: ${BROWSERSTACK_USERNAME}
    Log    App BrowserStack: ${BROWSERSTACK_APP}
    ...
    Open Application    ${REMOTE_URL_BSTACK}    desired_capabilities=${desired_caps}
